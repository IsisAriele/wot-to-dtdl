 ...
 * @generated
 */
public class WotSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WotPackage.INTERACTION_AFFORDANCE: {
			...
			case WotPackage.PROPERTY_AFFORDANCE: {
			...
			case WotPackage.ACTION_AFFORDANCE: {
			...
			case WotPackage.EVENT_AFFORDANCE: {
