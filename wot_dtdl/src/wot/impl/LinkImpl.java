 ...
 * </p>
 * <ul>
 *   <li>{@link wot.impl.LinkImpl#getHref <em>Href</em>}</li>
 *   <li>{@link wot.impl.LinkImpl#getRel <em>Rel</em>}</li>
 *   <li>{@link wot.impl.LinkImpl#getType <em>Type</em>}</li>
 *   <li>{@link wot.impl.LinkImpl#getAnchor <em>Anchor</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LinkImpl extends MinimalEObjectImpl.Container implements Link {
	...
	protected EClass eStaticClass() {
		return WotPackage.Literals.LINK;
	}
	...
	public void setType(String newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WotPackage.LINK__TYPE, oldType, type));
	}
