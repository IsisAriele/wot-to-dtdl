 ...
 * </p>
 * <ul>
 *   <li>{@link wot.impl.ActionAffordanceImpl#isSafe <em>Safe</em>}</li>
 *   <li>{@link wot.impl.ActionAffordanceImpl#isIdempotent <em>Idempotent</em>}</li>
 *   <li>{@link wot.impl.ActionAffordanceImpl#getInput <em>Input</em>}</li>
 *   <li>{@link wot.impl.ActionAffordanceImpl#getOutput <em>Output</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionAffordanceImpl extends InteractionAffordanceImpl implements ActionAffordance {
	...
	public NotificationChain basicSetInput(DataSchema newInput, NotificationChain msgs) {
		...
		input = newInput;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WotPackage.ACTION_AFFORDANCE__INPUT, oldInput, newInput);
	...
	public void setInput(DataSchema newInput) {
		if (newInput != input) {
			...
			if (input != null)
				msgs = ((InternalEObject)input).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WotPackage.ACTION_AFFORDANCE__INPUT, null, msgs);
			if (newInput != null)
				msgs = ((InternalEObject)newInput).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WotPackage.ACTION_AFFORDANCE__INPUT, null, msgs);
			msgs = basicSetInput(newInput, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WotPackage.ACTION_AFFORDANCE__INPUT, newInput, newInput));
	}
	...
	public NotificationChain basicSetOutput(DataSchema newOutput, NotificationChain msgs) {
		...
		output = newOutput;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WotPackage.ACTION_AFFORDANCE__OUTPUT, oldOutput, newOutput);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setOutput(DataSchema newOutput) {
		if (newOutput != output) {
			NotificationChain msgs = null;
			if (output != null)
				msgs = ((InternalEObject)output).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WotPackage.ACTION_AFFORDANCE__OUTPUT, null, msgs);
			if (newOutput != null)
				msgs = ((InternalEObject)newOutput).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WotPackage.ACTION_AFFORDANCE__OUTPUT, null, msgs);
			msgs = basicSetOutput(newOutput, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WotPackage.ACTION_AFFORDANCE__OUTPUT, newOutput, newOutput));
	}
